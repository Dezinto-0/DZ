...
public class Game {
    ...
    public void game() {
        ...
        while (!(comand.equals("выход"))) {
            if (comand.equals("осмотреться")) {
                player.lookAround();
            } else if (comand.equals("идти вверх")) {
                player.go(Direction.UP);
            } else if (comand.equals("идти вниз")) {
                player.go(Direction.DOWN);
            } else if (comand.equals("идти запад")) {
                player.go(Direction.WEST);
            } else if (comand.equals("идти восток")) {
                player.go(Direction.EAST);
            } else if (comand.equals("идти север")) {
                player.go(Direction.NORTH);
            } else if (comand.equals("идти юг")) {
                player.go(Direction.UP);
            } else if (comand.equals("инвентарь")) {
                player.inventory();
            } else if (comand.equals("взять ведро")) {
                player.take("ведро");
